...
typedef NS_ENUM(NSUInteger, WPFileManagerType) {
    WPFileManagerTypeCache = 1,
    WPFileManagerTypeOffline,
    WPFileManagerTypeLibrary,
    WPFileManagerTypeTmp,
    WPFileManagerTypeWXMovie    //清空缓存不会清空改类型
};
